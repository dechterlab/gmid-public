...
class Factor(object):
  ...
  def __str__(self):
    ...
    return 'Factor({:s})'.format(str(self.t))
  ...
  def isAny(self,test):
    """Generic check for any entries satisfying lambda-expression "unittests" in the factor"""
  ...
  def sign(self):
    return Factor().__build(self.v.copy(), np.sign(self.t))
  ...
  def nan_to_zero(self):
    """ check self.t and convert nan to -inf """
