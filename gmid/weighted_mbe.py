...
class WeightedMBE(MessagePassing):
    def __init__(self, verbose_level, message_graph, elim_order, weights, is_log, epsilon, log_file_name, ibound,
        ...
        super(WeightedMBE, self).__init__(verbose_level, message_graph, elim_order, weights, is_log, log_file_name)
    ...
    def _propagate_one_pass(self, time_limit, iter_limit, optimize_weight, optimize_cost):
        ...
        """
        const_valuations = []   # todo this constant should be multiplied per layer to be a heuristic
