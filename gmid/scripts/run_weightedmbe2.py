...
from gmid.weighted_mbe2 import *
...
def run(name="mdp1-4_2_2_5", ibound=1, iter_limit=20, time_limit=3600, optimize_weight=1, optimize_cost=1):
    ...
    #### WMB heuristic
    verbose_level = 0
    wmb_str = "_".join( [name, "WeightedMBE2", "iw=" + str(iw), "ibd=" + str(ibound),
    ...
    wmb_heur = WeightedMBE2(verbose_level, jgd, ordering, weights, is_log, WEPS, log_file_name, ibound, mini_buckets, gm.variables)
    wmb_heur.print_log("WeightedMBE2 (uniform init, inherit weight)")
